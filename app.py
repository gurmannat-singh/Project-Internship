...
# -----------------------------------
# Custom CSS (Dark & Light Mode Safe)
# -----------------------------------
st.markdown("""
<style>
...
/* Metric card container fix */
div[data-testid="stMetric"] {
    background-color: #1E293B !important; /* Dark solid card background */
...
/* Force metric label and text to be crisp and visible */
div[data-testid="stMetricLabel"] > label {
    color: #94A3B8 !important; /* Soft silver label */
    font-size: 16px !important;
    font-weight: 600 !important;
}

div[data-testid="stMetricValue"] > div {
    color: #38BDF8 !important; /* Vibrant bright blue salary text */
